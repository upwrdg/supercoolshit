...
export const FileUploadExtension = {
  ...
  render: ({ trace, element }) => {
    ...
    fileUploadContainer.innerHTML = `
      ...
      <div class='my-file-upload'>Drag and drop a file here or click to upload (JPEG, PNG, PDF only)</div>
    ...
    fileInput.addEventListener('change', function () {
      ...
      if (!file || !allowedTypes.includes(file.type)) {
        fileUploadContainer.innerHTML = '<div style="color: red;">Error: Only JPEG, PNG, and PDF files are allowed.</div>'
        return
      }
